...
/*
 * Define the class. Point in the plane.
Set the movement of the point in a certain direction. 
Create methods for determining the speed and acceleration of a point. 
Check for two points the possibility of crossing trajectories.
 * */
